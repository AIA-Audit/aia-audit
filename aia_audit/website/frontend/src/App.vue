...
<template>
    ...
    <Dialog header="Do you really want to exit?" v-model:visible="displayExitModal" :breakpoints="{'960px': '75vw', '640px': '90vw'}" :style="{width: '50vw'}" :modal="true">
      <p class="m-0">
    ...
    <!-- End Stop application (exit Modal)-->
