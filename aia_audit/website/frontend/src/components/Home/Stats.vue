        ...
        <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="#" class="font-medium text-blue-500 hover:text-blue-900">View all</a>
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted () {
        ...
        this.axios.get('/api/data/statistics/last-scan-date')
            .then(response => {
                this.lastScanDate = this.unixToTimestamp(response.data.last_scan_date)
            })
    }
}
</script>